    ...
    <main class="artwork-detail-layout container">
        ...
        <div class="artwork-right">
            ...
            <div class="artisan-profile-card">
                ...
                <button class="btn btn-outline" id="btn-follow" data-following="false" style="border-radius: var(--radius-md);">Follow</button>
            </div>
            ...
            <div class="kudos-horizontal-card">
                <div class="kudos-badge-item" data-badge-type="technique" aria-label="Appreciate technique">
                ...
                <div class="kudos-badge-item" data-badge-type="love" aria-label="Love this piece">
                    <!-- Heart -->
                    <svg width="24" height="24" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="kudos-badge-item" data-badge-type="creative" aria-label="Praise creativity">
                    <!-- Lightbulb -->
                    <svg width="24" height="24" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="kudos-badge-item" data-badge-type="inspiring" aria-label="Find inspiring">
                    <!-- Hand (Thumbs Up) -->
                    <svg width="24" height="24" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div style="margin-top: 1rem; display: flex; gap: 0.75rem; align-items: center; flex-wrap: wrap;">
                <button class="btn btn-outline" id="btn-save-artwork" data-saved="false" style="border-radius: var(--radius-md); display: flex; align-items: center; gap: 0.5rem;">
                    <svg width="18" height="18" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z"></path>
                    </svg>
                    <span id="btn-save-text">Save for Later</span>
                </button>
            </div>
